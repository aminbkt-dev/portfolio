      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mt-16 pt-14 border-t border-slate-200">
          ...
          <p className="text-slate-500 text-sm leading-relaxed mb-10 max-w-2xl">
            J&apos;ai con&ccedil;u et exploit&eacute; ce syst&egrave;me de reporting sur deux outils BI compl&eacute;mentaires. <strong className="text-slate-700">Power BI</strong> &mdash; standard du march&eacute; enterprise &mdash; m&apos;a permis de piloter concr&egrave;tement la performance sur 8 pages analytiques&nbsp;: rentabilit&eacute; et co&ucirc;ts par collection, analyse produit, v&eacute;locit&eacute; des ventes, stock et projections de CA, et corr&eacute;lations entre co&ucirc;ts et profits. J&apos;ai &eacute;galement d&eacute;ploy&eacute; <strong className="text-slate-700">Metabase</strong> pour r&eacute;pondre &agrave; des besoins sp&eacute;cifiques&nbsp;: acc&egrave;s web, partage simplifi&eacute; et rafra&icirc;chissement automatique des donn&eacute;es, sans d&eacute;pendance &agrave; une licence ou un poste fixe.
          </p>
